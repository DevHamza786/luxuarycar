...
<section class="contact_form_section sec_ptb_100 clearfix">
    <div class="container">
        ...
        <form id="contact_form" action="mail.php" method="POST" novalidate="novalidate">
            ...
            <div class="form_item aos-init aos-animate" data-aos="fade-up" data-aos-delay="700"><textarea name="message"
                    placeholder="Leave Your Message"></textarea></div>
            <div class="abtn_wrap text-center clearfix aos-init" data-aos="fade-up" data-aos-delay="800"><button
                    ...
                    Message <img src="{{ asset('home/assets/images/icons/icon_01.png')}}" alt="icon_not_found"></button></div>
        </form>
    </div>
</section>
@endsection
